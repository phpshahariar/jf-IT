                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('/save/education/tag')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row clearfix">
                                                <div class="col-sm-12">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                @foreach($show_tag as $key => $show)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>
                                            @if(isset($show->image))
                                                <img src="{{ asset('slider-images/'.$show->image) }}" height="50" width="200">
                                            @else
